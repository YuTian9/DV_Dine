...
plot(eb,adj_mtx_g,layout=layout.fruchterman.reingold)
eb$membership

wt<-walktrap.community(adj_mtx_g,steps=200,modularity=TRUE) ##run random walk partitioning
plot(wt,adj_mtx_g,layout=layout.spring) ##plotR-Wpartitioning 
wt$membership

lp=label.propagation.community(adj_mtx_g) ##runlabelpropogationpartitioning 
plot(lp,adj_mtx_g,layout=layout.spring) ##plotL-Ppartitioning
lp$membership
